...
def test_new_hr_set_between():
    # This case checks for when user input is not divisible by predetermined window (e.g. 0.67 min)
    min2 = 0.67
    rawbunches = [80, 79, 85, 90, 77, 73]
...
def test_groupnum_greaterthan_data():
    # This tests when user inputs a time greater than the dataset allows
